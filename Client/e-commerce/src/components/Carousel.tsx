            ...
            <div id="carouselExampleAutoplaying" className="carousel slide" data-bs-theme="light" data-bs-ride={autoPlay ? "carousel" : "false"} >
                <div className="carousel-inner" >
                    ...
                    <div className="carousel-item active" data-bs-interval="5500">
                        <img src={arrayImages[0]} className="d-block w-100" alt="Imagen del producto 1" />
                    </div>
                    {
                        arrayImages.slice(1).map((image: string, index: number) => {
                            return (
                                <div
                                    key={image}
                                    className="carousel-item" data-bs-interval="5500">
                                    <img src={image} className="d-block w-100 " alt={`Imagen del producto ${index + 2}`} />
                                </div>
                            )
                        })
                    }
